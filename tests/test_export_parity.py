...
def test_export_figure_day_matches_notebook_default():
    """The day the within-day figures inspect must equal the notebooks' day_sel
    default, so the exported figures reproduce what the notebooks show by
    default. (Guards the inspected-day discrepancy that the ``_base`` config
